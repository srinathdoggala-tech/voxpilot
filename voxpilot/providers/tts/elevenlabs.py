...
class ElevenLabsTTSProvider(TTSProvider):
    """ElevenLabs Turbo v2.5 streaming TTS provider abstraction wrapper."""

    def __init__(self, api_key: str | None = None, model: str = "eleven_turbo_v2_5"):
    ...
    async def synthesize_stream(self, text: str, voice_id: str | None = None) -> AsyncGenerator[TTSAudioFrame, None]:
        """Stream TTS audio via ElevenLabs WebSocket API."""
        if not self.api_key:
